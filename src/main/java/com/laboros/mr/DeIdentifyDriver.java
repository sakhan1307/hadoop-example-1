...
//load deidentify datasets into hdfs
//$ hadoop fs -put Datasets/DeIdentify/ /user/edureka/

//$ yarn jar hadoop-example-1-0.0.1-SNAPSHOT.jar com.laboros.mr.DeIdentifyDriver /user/edureka/DeIdentify /user/edureka/DOP
